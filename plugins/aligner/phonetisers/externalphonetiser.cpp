...
ExternalPhonetiser::ExternalPhonetiser(QObject *parent) :
    QObject(parent), d(new ExternalPhonetiserData)
{
...
QList<AlignerToken> mergePhonetiserTokens(const QList<AlignerToken> &ptokens)
{
    QList<AlignerToken> merged;
    int i = 0, j = 0;
...
// static
QList<AlignerToken> ExternalPhonetiser::phonetiseList(QList<Interval *> tokens, const QString &attributeID)
{
    QList<AlignerToken> ptokens;
    int i = 0;
...
// static
QList<AlignerToken> ExternalPhonetiser::phonetiseTier(IntervalTier *tier_tokens, const QString &attributeID)
{
...
{
    QList<AlignerToken> atokens = phonetiseTier(tier_tokens, attributeIDOrthographic);
