#ifndef DISFLUENCYDETECTOR_H
#define DISFLUENCYDETECTOR_H
...
class DisfluencyDetector : public CRFAnnotator
{
public:
    DisfluencyDetector(TokenList &tokens) : CRFAnnotator(tokens) {}
protected:
...
private:
    QString m_previous_tokunit;
    int editDistance(const QString &A, const QString &B);
};

}

#endif // DISFLUENCYDETECTOR_H
