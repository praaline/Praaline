...
bool CorporaTableModel::setData(const QModelIndex &index, const QVariant &value, int role)
{
...
Qt::ItemFlags CorporaTableModel::flags(const QModelIndex &index) const
{
    if (!index.isValid())
...
bool CorporaTableModel::insertRows(int row, int count, const QModelIndex &parent)
{
