...
class PRAALINE_ASR_SHARED_EXPORT KaldiConfiguration
{
public:
    KaldiConfiguration();
...
class PRAALINE_ASR_SHARED_EXPORT KaldiMonophoneConfig : public KaldiConfiguration
{
public:
...
class PRAALINE_ASR_SHARED_EXPORT KaldiTriphoneConfig : public KaldiMonophoneConfig
{
public:
...
class PRAALINE_ASR_SHARED_EXPORT KaldiTriphoneFmllrConfig : public KaldiTriphoneConfig
{
public:
...
class PRAALINE_ASR_SHARED_EXPORT MfccConfig : public KaldiConfiguration
{
