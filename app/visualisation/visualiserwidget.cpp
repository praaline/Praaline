...
void
VisualiserWidget::updateDescriptionLabel()
{
    if (!getMainModel()) {
...
void
VisualiserWidget::documentModified()
{
    //!!!
...
void
VisualiserWidget::documentRestored()
{
    //!!!
...
void
VisualiserWidget::toolMeasureSelected()
{
    m_viewManager->setToolMode(ViewManager::MeasureMode);
}

void
VisualiserWidget::importAudio()
{
...
void
VisualiserWidget::importMoreAudio()
{
    QString path = getOpenFileName(FileFinder::AudioFile);
...
void
VisualiserWidget::replaceMainAudio()
{
    QString path = getOpenFileName(FileFinder::AudioFile);
...
void
VisualiserWidget::exportAudio(bool asData)
{
...
void
VisualiserWidget::documentReplaced()
{
    if (m_document) {
...
void
VisualiserWidget::paneAdded(Pane *pane)
{
    if (m_overview) m_overview->registerView(pane);
}

void
VisualiserWidget::paneHidden(Pane *pane)
{
    if (m_overview) m_overview->unregisterView(pane);
}

void
VisualiserWidget::paneAboutToBeDeleted(Pane *pane)
{
    if (m_overview) m_overview->unregisterView(pane);
}

void
VisualiserWidget::paneDropAccepted(Pane *pane, QStringList uriList)
{
...
void
VisualiserWidget::preferenceChanged(PropertyContainer::PropertyName name)
{
...
void
VisualiserWidget::restoreNormalPlayback()
{
    m_playSpeed->setValue(m_playSpeed->defaultValue());
}

void
VisualiserWidget::currentPaneChanged(Pane *pane)
{
...
void
VisualiserWidget::updateVisibleRangeDisplay(Pane *p) const
{
    if (!getMainModel() || !p) {
        return;
    }
...
void
VisualiserWidget::updatePositionStatusDisplays() const
{
...
void
VisualiserWidget::outputLevelsChanged(float left, float right)
{
...
void
VisualiserWidget::mainModelChanged(WaveFileModel *model)
{
...
void
VisualiserWidget::mainModelGainChanged(float gain)
{
    if (m_playTarget) {
...
void
VisualiserWidget::modelAboutToBeDeleted(Model *model)
{
...
void
VisualiserWidget::mouseEnteredWidget()
{
