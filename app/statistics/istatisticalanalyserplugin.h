#ifndef ISTATISTICALANALYSERPLUGIN_H
#define ISTATISTICALANALYSERPLUGIN_H
...
namespace Praaline {
    namespace Plugins {
        class IStatisticalAnalyserPlugin : public IPlugin
        {
        public:
            ...
            IStatisticalAnalyserPlugin() : IPlugin() {}
            virtual ~IStatisticalAnalyserPlugin() {}

            virtual QList<PluginParameter> pluginParameters() const = 0;
            virtual void setParameters(QHash<QString, QVariant> parameters) = 0;

            virtual void process(QPointer<Corpus> corpus, QList<QPointer<CorpusCommunication> > communications) = 0;
        signals:
...
Q_DECLARE_INTERFACE(Praaline::Plugins::IStatisticalAnalyserPlugin, "org.Praaline.Plugins.IStatisticalAnalyserPlugin/1.0")

#endif // ISTATISTICALANALYSERPLUGIN_H
