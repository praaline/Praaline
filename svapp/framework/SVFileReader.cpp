...
SVFileReader::readModel(const QXmlAttributes &attributes)
{
    ...
    cerr << "SVFileReader::readModel: model name \"" << name << "\"" << endl;
    ...
    if (type == "wavefile") {
        ...
        cerr << "Wave file originalPath = " << originalPath << ", path = "
                  << path << endl;
...
//    cerr << "SVFileReader::addPointToDataset: frame = " << frame << endl;
...
//        cerr << "Current dataset is a text model" << endl;
	...
	QString label = attributes.value("label");
//        cerr << "SVFileReader::addPointToDataset: TextModel: frame = " << frame << ", height = " << height << ", label = " << label << ", ok = " << ok << endl;
...
//        cerr << "SVFileReader::addPointToDataset: PathModel: frame = " << frame << ", mapframe = " << mapframe << ", ok = " << ok << endl;
...
//        cerr << "Current dataset is an image model" << endl;
	...
	QString label = attributes.value("label");
//        cerr << "SVFileReader::addPointToDataset: ImageModel: frame = " << frame << ", image = " << image << ", label = " << label << ", ok = " << ok << endl;
...
SVFileReader::readDerivation(const QXmlAttributes &attributes)
{
    ...
    if (type == "transform") {
        ...
        cerr << "NOTE: SV-XML: Reading old-style derivation element"
                  << endl;
    }
...
{
    cerr << "SVFileReader::readMeasurement: inLayer "
