...
const char32 * Table_getColStr (I, long columnNumber) {
	iam(Table);	
...
const char32 * Table_getMatrixStr (I, long rowNumber, long columnNumber) {
	iam(Table);
	return me -> v_getMatrixStr(rowNumber, columnNumber);
}

double Table_getColIndex  (I, const char32 *columnLabel) {
	iam(Table);
