...
PRAAT_LIB_EXPORT TextGrid TextGrids_merge (TextGrid grid1, TextGrid grid2);
/*
	Merge two textGrids.
...
PRAAT_LIB_EXPORT void TextTier_changeLabels (I, long from, long to, const char32 *search, const char32 *replace, int use_regexp, long *nmatches, long *nstringmatches);

PRAAT_LIB_EXPORT void IntervalTier_changeLabels (I, long from, long to, const char32 *search, const char32 *replace, int use_regexp, long *nmatches, long *nstringmatches);
...
// Postcondition:
PRAAT_LIB_EXPORT TextGrid TextGrids_to_TextGrid_appendContinuous (Collection me, bool preserveTimes);
