...
#undef ooSTRUCT
#ifdef PRAAT_LIB
PRAAT_LIB_EXPORT double Function_getXmin (I);
PRAAT_LIB_EXPORT double Function_getXmax (I);
PRAAT_LIB_EXPORT int Function_domainQuantity (I);
PRAAT_LIB_EXPORT void Function_shiftX (I, double xfrom, double xto);
PRAAT_LIB_EXPORT void Function_scaleX (I, double xminfrom, double xmaxfrom, double xminto, double xmaxto);
#endif
