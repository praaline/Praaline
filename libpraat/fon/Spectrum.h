...
*/
PRAAT_LIB_EXPORT Spectrum Spectrum_create (double fmax, long nf);
/* Preconditions:
		fmax > 0.0;
		nf >= 2;
	Postconditions:
...
PRAAT_LIB_EXPORT Table Spectrum_downto_Table (Spectrum me, bool includeBinNumbers, bool includeFrequency,
...
PRAAT_LIB_EXPORT Spectrum Matrix_to_Spectrum (Matrix me);

PRAAT_LIB_EXPORT Matrix Spectrum_to_Matrix (Spectrum me);

PRAAT_LIB_EXPORT Spectrum Spectrum_cepstralSmoothing (Spectrum me, double bandWidth);
