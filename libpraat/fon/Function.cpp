...
#ifdef PRAAT_LIB
double Function_getXmin (I) { iam(Function); return my xmin; }
double Function_getXmax (I) { iam(Function); return my xmax; }
int Function_domainQuantity (I) { return 0; }
void Function_shiftX (I, double xfrom, double xto)
	{ iam(Function); return me -> v_shiftX (xfrom, xto); }
void Function_scaleX (I, double xminfrom, double xmaxfrom, double xminto, double xmaxto)
	{ iam(Function); return me -> v_scaleX (xminfrom, xmaxfrom, xminto, xmaxto); }
#endif
