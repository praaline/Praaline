...
PRAAT_LIB_EXPORT Ltas Ltas_create (long nx, double dx);
/*
	Function:
...
PRAAT_LIB_EXPORT Matrix Ltas_to_Matrix (Ltas me);
PRAAT_LIB_EXPORT Ltas Matrix_to_Ltas (Matrix me);

PRAAT_LIB_EXPORT Ltas Ltases_merge (Collection ltases);
PRAAT_LIB_EXPORT Ltas Ltases_average (Collection ltases);

PRAAT_LIB_EXPORT Ltas Ltas_computeTrendLine (Ltas me, double fmin, double fmax);
PRAAT_LIB_EXPORT Ltas Ltas_subtractTrendLine (Ltas me, double fmin, double fmax);

/* Direct computations. */

PRAAT_LIB_EXPORT Ltas Spectrum_to_Ltas (Spectrum me, double bandwidth);
PRAAT_LIB_EXPORT Ltas Spectrum_to_Ltas_1to1 (Spectrum me);
PRAAT_LIB_EXPORT Ltas PointProcess_Sound_to_Ltas (PointProcess pulses, Sound sound,
	double maximumFrequency, double bandWidth,
	double shortestPeriod, double longestPeriod, double maximumPeriodFactor);
PRAAT_LIB_EXPORT Ltas PointProcess_Sound_to_Ltas_harmonics (PointProcess pulses, Sound sound,
	long maximumHarmonic,
	double shortestPeriod, double longestPeriod, double maximumPeriodFactor);

/* Shortcuts. */

PRAAT_LIB_EXPORT Ltas Sound_to_Ltas (Sound me, double bandwidth);
PRAAT_LIB_EXPORT Ltas Sound_to_Ltas_pitchCorrected (Sound sound, double minimumPitch, double maximumPitch,
	double maximumFrequency, double bandWidth,
	double shortestPeriod, double longestPeriod, double maximumPeriodFactor);
