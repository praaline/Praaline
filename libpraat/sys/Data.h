...
PRAAT_LIB_EXPORT Data Data_readFromTextFile (MelderFile file);
/*
	Message:
...
PRAAT_LIB_EXPORT Data Data_readFromBinaryFile (MelderFile file);
/*
	Message:
...
PRAAT_LIB_EXPORT Data Data_readFromFile (MelderFile file);
/*
Purpose:
