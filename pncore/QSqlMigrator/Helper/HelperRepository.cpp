...
HelperRepository::HelperRepository(const QuoteService &quoteService, const TypeMapperService &typeMapperService,
                                   const ColumnService &columnService, const SqlStructureService &sqlStructureService) :
