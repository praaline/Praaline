...
#define QSQL_MIGRATION(MigrationClass) \
     extern QSqlMigrator::Migrations::RegisterMigration<MigrationClass> RegisterMigration_##MigrationClass;

#define QSQL_MIGRATION_IMPL(MigrationClass) \
     QSqlMigrator::Migrations::RegisterMigration<MigrationClass> RegisterMigration_##MigrationClass(#MigrationClass);
